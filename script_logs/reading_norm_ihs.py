...
#Running meta-ss with selsig outputs from Tajima's D, fst, ihs, nsl, xpeeh,and isafe.
#All tests were binned into 10Kb scanning windows. 
#At the end of this script, outputting bed file for each breed (atfl, chbt, 
#chbi, chha, chme, and chya) containing regions with threshold above 
...
#home_dir define where the test outputs with binning windows are located, 
#structure of the folder as follows:
#home_dir\
#home_dir\test1
#home_dir\test1\breed1\
#home_dir\test1\breed2\
#home_dir\test2    
#home_dir\test2\breed1\
...
atfl.sig_regions.iloc[:, 0:3].to_csv(os.path.join(home_dir,"sign_regions","atfl") ,sep="\t", header=None, index=None)
...
plt.show()
#taking columns 0 to 2 of significant regions and write it to bed file wo header&index
chbt.sig_regions.iloc[:, 0:3].to_csv(os.path.join(home_dir,"sign_regions","chbt") ,sep="\t", header=None, index=None)
...
plt.show()
#taking columns 0 to 2 of significant regions and write it to bed file wo header&index
chbi.sig_regions.iloc[:, 0:3].to_csv(os.path.join(home_dir,"sign_regions","chbi") ,sep="\t", header=None, index=None)
...
plt.show()
#taking columns 0 to 2 of significant regions and write it to bed file wo header&index
chha.sig_regions.iloc[:, 0:3].to_csv(os.path.join(home_dir,"sign_regions","chha") ,sep="\t", header=None, index=None)
...
plt.show()
#taking columns 0 to 2 of significant regions and write it to bed file wo header&index
chme.sig_regions.iloc[:, 0:3].to_csv(os.path.join(home_dir,"sign_regions","chme") ,sep="\t", header=None, index=None)
